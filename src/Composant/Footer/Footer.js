        ...
        <footer class="footer">
            ...
            <ul class="footer__nav">
                <li class="nav__item">
                    ...
                    <h5 class="socialmedia_text">Instagram</h5>
                </li>

                <li class="nav__item">
                    <a className="socialmedia" href="https://twitter.com/torekkocom?s=20"><img className="socialmedia_logo" src={Twitter} alt="Instagram" /></a>
                    <h5 class="socialmedia_text">Twitter</h5>
                </li>

                <li class="nav__item">
                    <a className="socialmedia" href="https://www.linkedin.com/company/torekko/"><img className="socialmedia_logo" src={Linkedin} alt="Instagram" /></a>
                    <h5 class="socialmedia_text">Linkedin</h5>
                </li>

                <li class="nav__item">
                    <a className="socialmedia" href="https://t.me/torekko"><img className="socialmedia_logo" src={Telegram} alt="Instagram" /></a>
                    <h5 class="socialmedia_text">Community</h5>
                </li>
                <li class="nav__item">
                    <a className="socialmedia" href="https://t.me/torekkoann"><img className="socialmedia_logo" src={Telegram} alt="Telegram" /></a>
                    <h5 class="socialmedia_text">Announcements</h5>
                </li>
                <li class="nav__item">
                    <a className="socialmedia" href="https://discord.gg/Tnwtu5YjDA"><img className="socialmedia_logo" src={Discord} alt="Discord" /></a>
                    <h5 class="socialmedia_text">Discord</h5>
                </li>
            </ul>
